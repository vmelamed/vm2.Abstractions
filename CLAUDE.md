# vm2.Abstractions — Claude Context
...
- Repo: <https://github.com/vmelamed/vm2.Abstractions>
- NuGet: <https://www.nuget.org/packages/vm2.Abstractions/>
...
dotnet run --project benchmarks/Abstractions.Benchmarks --configuration Release -- --filter "*"
```
